...
#  Max Score: 5 points
#
# Students: Students: Yaolei Bian, Allen Leinberger, Mohammed Alrkhayes
#
#
...
#      values stored in register $s1 as the program progresses.
                 #0x00000000, 0xfffffffe, 0xfffffffa, 0x00000001  
# 4.   What is the purpose of register $t0 in this program?
#		$t0 stores the address location of the currently used element of X in the sum.
#
#
